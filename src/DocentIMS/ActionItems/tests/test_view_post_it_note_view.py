...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_post_it_note_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='post-it-note-view'
        )
        self.assertTrue(view.__name__ == 'post-it-note-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in post-it-note-view'
        # )

    def test_post_it_note_view_not_matching_interface(self):
