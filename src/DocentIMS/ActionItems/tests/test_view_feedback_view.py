...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_feedback_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='feedback-view'
        )
        self.assertTrue(view.__name__ == 'feedback-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in feedback-view'
        # )

    def test_feedback_view_not_matching_interface(self):
