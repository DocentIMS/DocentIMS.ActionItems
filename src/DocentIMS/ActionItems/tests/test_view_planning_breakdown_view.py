...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_planning_breakdown_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='planning-breakdown-view'
        )
        self.assertTrue(view.__name__ == 'planning-breakdown-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in planning-breakdown-view'
        # )

    def test_planning_breakdown_view_not_matching_interface(self):
