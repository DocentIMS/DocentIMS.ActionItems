...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_users_import_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='users-import'
        )
        self.assertTrue(view.__name__ == 'users-import')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in users-import'
        # )

    def test_users_import_not_matching_interface(self):
