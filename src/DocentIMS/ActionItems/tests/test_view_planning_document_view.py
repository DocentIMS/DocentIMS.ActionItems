...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_planning_document_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='planning-document-view'
        )
        self.assertTrue(view.__name__ == 'planning-document-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in planning-document-view'
        # )

    def test_planning_document_view_not_matching_interface(self):
