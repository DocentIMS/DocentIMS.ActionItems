...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_documents_folder_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='documents-folder-view'
        )
        self.assertTrue(view.__name__ == 'documents-folder-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in documents-folder-view'
        # )

    def test_documents_folder_view_not_matching_interface(self):
