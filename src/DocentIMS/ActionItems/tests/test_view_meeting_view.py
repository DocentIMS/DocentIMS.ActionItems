...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_meeting_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='meeting-view'
        )
        self.assertTrue(view.__name__ == 'meeting-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in meeting-view'
        # )

    def test_meeting_view_not_matching_interface(self):
