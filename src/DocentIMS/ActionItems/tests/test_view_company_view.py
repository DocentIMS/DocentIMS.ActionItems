...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_company_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='company-view'
        )
        self.assertTrue(view.__name__ == 'company-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in company-view'
        # )

    def test_company_view_not_matching_interface(self):
