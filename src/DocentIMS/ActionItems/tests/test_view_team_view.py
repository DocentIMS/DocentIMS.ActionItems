...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_team_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='team-view'
        )
        self.assertTrue(view.__name__ == 'team-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in team-view'
        # )

    def test_team_view_not_matching_interface(self):
