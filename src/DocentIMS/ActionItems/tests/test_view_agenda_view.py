...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_agenda_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='agenda-view'
        )
        self.assertTrue(view.__name__ == 'agenda-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in agenda-view'
        # )

    def test_agenda_view_not_matching_interface(self):
