...
#
#  $ bin/test -s DocentIMS.ActionItems -t test_meeting.robot --all
#
...
# 2) Run robot tests:
#
# $ bin/robot /src/DocentIMS/ActionItems/tests/robot/test_meeting.robot
#
...
a Meeting 'My Meeting'
  Create content  type=Meeting  id=my-meeting  title=My Meeting
