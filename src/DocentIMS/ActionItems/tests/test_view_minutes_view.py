...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_minutes_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='minutes-view'
        )
        self.assertTrue(view.__name__ == 'minutes-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in minutes-view'
        # )

    def test_minutes_view_not_matching_interface(self):
