...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_member_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='member-view'
        )
        self.assertTrue(view.__name__ == 'member-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in member-view'
        # )

    def test_member_view_not_matching_interface(self):
